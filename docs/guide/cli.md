...
```bash [npm]
npx @joakimbugge/typeorm-seeder seed:list -d ./src/datasource.ts
```

```bash [yarn]
yarn @joakimbugge/typeorm-seeder seed:list -d ./src/datasource.ts
```

```bash [pnpm]
pnpm exec @joakimbugge/typeorm-seeder seed:list -d ./src/datasource.ts
```
