...
```bash [yarn]
yarn @joakimbugge/mikroorm-seeder seed:untrack UserSeeder -o ./dist/orm.js
```

```bash [pnpm]
pnpm exec @joakimbugge/mikroorm-seeder seed:untrack UserSeeder -o ./dist/orm.js
```
