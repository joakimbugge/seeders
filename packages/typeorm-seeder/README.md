...
Verify these are enabled in your `tsconfig.json` (they should already be — TypeORM requires them):
...
> [!IMPORTANT]
> **Tree depth is limited to one level**
>
...
> [!NOTE]
> **Seeded entities always have a parent when `@TreeParent` is annotated with `@Seed()`**
>
